...
import { EasyPenColorStyle, EasyPenStyle, Pen } from 'src/app/whiteboard/global/interfaces/penStyle';
...
export class PenStyleComponent extends AbstractPickerComponent<Picker<Pen>, Pen> implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      this.sliderInputPicker = new SliderInputPicker(() => this.picker?.value?.lineWidth, (t: number) => { if (this.picker?.value) this.picker.value.lineWidth = t }, 1, 2, true);
