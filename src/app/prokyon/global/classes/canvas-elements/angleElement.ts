...
import { ViewAngleElementComponent } from "src/app/prokyon/formula-dialogs/view-angle-element/view-angle-element.component";
...
export default class AngleElement extends ProkyonCanvasElement {
            ...
            if (c !== undefined) {
                ctx.drawCircleSector(c, 
                    ...
                    },
                    {
                        ...
                        lineDash: this.configuration.dashed ? REGULAR_LINEDASH : undefined,
                        uniformSizeOnZoom: true
                    })
